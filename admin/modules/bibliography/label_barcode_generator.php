...
if (isset($_GET['action']) AND $_GET['action'] == 'print') {
  ...
  $header_color = array(0=>"#E91E63",1=>"#673AB7",2=>"#FFC107",3=>"#26A69A",4=>"#26C6DA",5=>"#CDDC39",6=>"#FF9800",7=>"#42A5F5",8=>"#EF5350",9=>"#66BB6A");
  $text_color = array(0=>"#FFF",1=>"#FFF",2=>"#000",3=>"#000",4=>"#000",5=>"#000",6=>"#000",7=>"#000",8=>"#000",9=>"#000");
